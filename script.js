...
const translations = {
    es: {
        ...
        hero_subtitle: "Una holding moderna que centraliza propiedad intelectual, contabilidad y arquitectura interempresarial—asegurando eficiencia, privacidad y control operacional en todo su propio ecosistema de negocios.",
        hero_button: "Conócenos",
        about_section_title: "Quien Somos?",
    ...
    en: {
        ...
        hero_subtitle: "A modern holding company that centralizes intellectual property, accounting, and intercompany architecture—ensuring efficiency, privacy, and operational control across its own business ecosystem.",
